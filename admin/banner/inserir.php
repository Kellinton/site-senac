...
<div class="inserir-container">
    ...
    <form class="form-container" action="index.php?p=banner&b=inserir" method="POST" enctype="multipart/form-data" class="form">
        ...
        <div class="form-img">
            ...
            <input type="file" required name="imgBanner" id="inputImagem">
            </div>
        </div>

        <div class="form-content">
            <input required type="text" id="altBanner" name="altBanner" placeholder="Informe o texto alternativo: ">
            <textarea required name="textBanner" id="textBanner" cols="30" rows="10" placeholder="Informe o texto: "></textarea>
            <input required type="url" name="linkBanner" id="linkBanner" placeholder="Informe o link: ">
            <input class="formBtn" type="submit" value="Inserir">
        </div>

        <div>
            
        <input required type="checkbox" name="statusBanner" id="checkbox" value="ATIVO">
