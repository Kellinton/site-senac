<?php
    ...
    if(isset($_POST['tituloServico'])){
        ...
        if(!empty($_FILES['imgServico']['name'])){ // se nõa estiver vazia o campo do file
...
<div class="inserir-container">
    ...
    <form class="form-container" action="index.php?p=servico&s=atualizar&id=<?php echo $servico->idServico?>" method="POST" enctype="multipart/form-data" class="form">
        ...
        <div class="form-content">
            <input required type="text" id="tituloServico" name="tituloServico" placeholder="Informe o título: " value="<?php echo $servico->tituloServico?>">
            <textarea required name="textServico" id="textServico" cols="30" rows="10" placeholder="Informe o texto: "><?php echo $servico->textServico?></textarea>
            <input required type="url" name="linkServico" id="linkServico" placeholder="Informe o link: " value="<?php echo $servico->linkServico?>">
            <input class="formBtn" type="submit" value="Atualizar">
        </div>

        <div>
            
        <input required type="checkbox" name="statusServico" id="checkbox" value="<?php echo $servico->statusServico?>">
